...
<div class="toolblock big"> <img src="images/unarchive.png" alt="Unarchive" /> 
	<span>Select a zip file that you want to deploy</span>
  <input name="file" type="file" class="left" id="file" size="50" />
